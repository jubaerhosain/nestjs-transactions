...
📖 **[Full documentation → nestjs-transactions.jubaer.dev](https://nestjs-transactions.jubaer.dev/)** (see [Core & writing an adapter](https://nestjs-transactions.jubaer.dev/docs/core/adapter-authors))
...
See the **[adapter authors guide](https://nestjs-transactions.jubaer.dev/docs/core/adapter-authors)** for a walkthrough of writing your own adapter.
