...
- Transaction lifecycle hooks — `runOnTransactionCommit` / `runOnTransactionRollback` / `runOnTransactionComplete` (built on CLS, nothing rewritten at boot), re-exported by every adapter.
